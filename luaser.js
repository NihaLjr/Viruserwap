...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:🦠VIRUS SER OFC\n'
            + 'ORG:Owner VIRUS;\n'
            + 'TEL;type=CELL;type=VOICE;waid=919497862197:+919497862197\n'
            + 'END:VCARD'
       
const vcard1 = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n'
            + 'FN:SIDHU SER OFFICIAL\n'
            + 'ORG:Co Owner VIRUS;\n'
...
memberLimit = 1
ban = []
premium = ["919497862197@s.whatsapp.net","918592026326@s.whatsapp.net"]
...
🥳 WELCOME 🫂`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const DnsBot = ["919497862197@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["919497862197@s.whatsapp.net","15749993995@s.whataapp.net"] // owner number ubah aja
			...
			const checkLimit = (sender) => {
				...
				try {
					const getmemex = groupMembers.length
					    ...
					    denz.sendMessage(from, `ᴍᴀᴀғ 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍 ᴛɪᴅᴀᴋ ʙɪꜱᴀ ᴍᴀꜱᴜᴋ ɢʀᴏᴜᴘ ᴋᴀʀɴᴀ ᴍᴇᴍʙᴇʀ ɢʀᴏᴜᴘ *${groupMetadata.subject}* ᴛɪᴅᴀᴋ ᴍᴇᴍᴇɴᴜʜɪ ʟɪᴍɪᴛ ᴍᴇᴍʙᴇʀ\n\nᴍɪɴɪᴍᴀʟ ᴍᴇᴍʙᴇʀ *${memberLimit}*`, text)
					setTimeout( () => {
		...
		setTimeout( () => {
		reply(`ᴍᴀᴀғ 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍 ꜱᴇɢᴇʀᴀ ᴋᴇ𝚅𝙸𝚁𝚄𝚂ʀ ᴅᴀʀɪ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "type #menu sis", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
		...
		reply(`*_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nsᴏʀʀʏ *${pushname2}* ʏᴏᴜ ᴀʀᴇ ᴛᴀʟᴋɪɴɢ ᴅɪʀᴛʏ!, ʏᴏᴜ ᴀʀᴇ ɪᴍᴍᴇᴅɪᴀᴛᴇʟʏ ɪɴ ᴛʜᴇ ᴋɪᴄᴋ ᴏғ ᴛʜᴇ ɢʀᴏᴜᴘ *${groupMetadata.subject}*`)
			...
			dmenu = `╓───「 *_𝐕𝐈𝐑𝐔𝐒 𝐒𝐄𝐑 𝐔𝐘𝐈𝐑_* 」
║𝐻𝐴𝐼 𝐼'𝑀 𝐵𝑂𝑇  🕊️
╙───々
╓───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
║🧧 ᴄʀᴇᴀᴛᴏʀ: 𝟒 𝟒 𝟒
║🧾 ʀᴇᴄᴏᴅᴇ ʙʏ: ᴠɪʀᴜs ᴛᴇᴀᴍ
║🕯️ ᴘʀᴇғɪx: ${prefix}
║🎀 ᴜꜱᴇʀ ʀᴇɢɪsᴛᴇʀᴇᴅ: ${user.length}
║👹𝙾𝚆𝙽𝙴𝚁: ᴠɪʀᴜs sᴇʀ 𝚑𝚝𝚝𝚙://𝚠𝚊.𝚖𝚎/919497862197
║👺𝙲𝙾𝙾𝚆𝙽𝙴𝚁: ᴄʜᴜɢᴀ ᴅᴇᴠᴀɴ 𝚂𝙴𝚁 http://wa.me/918592026326
║🤯𝙵𝙾𝙻𝙻𝙾𝚆 𝙼𝙴 𝙾𝙽 𝙸𝙽𝚂𝚃𝙰: https://instagram.com/virus_kwid?utm_medium=copy_link
...
║✨ ${prefix}ɴᴀʀᴜᴛᴏʙᴀɴɴᴇʀ
║✨ ${prefix}ᴘᴀᴘᴇʀɢʟᴀꜱꜱ
║✨ ${prefix}ʙʟᴜᴇɴᴇᴏɴ 𝚅𝙸𝚁𝚄𝚂
║✨ ${prefix}ꜱʜᴀᴅᴏᴡ
║✨ ${prefix}ɢʟɪᴛᴄʜ 𝚅𝙸𝚁𝚄𝚂/sᴇʀ
║✨ ${prefix}ᴄᴏғғᴇ
║✨ ${prefix}ᴍᴀᴛʀɪx 𝚅𝙸𝚁𝚄𝚂
║✨ ${prefix}ʜᴘᴏᴛᴛᴇʀ
║✨ ${prefix}ᴡᴏᴏᴅʙʟᴏᴄᴋ
...
denz.sendMessage(from, dmenu, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "mwonu   𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍❤️", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')}}}})
denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true}) 	    
            break
            case 'menu2':
			if (isBanned) return reply(mess.only.benned)
				...
				case 's':
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								...
								denz.sendMessage(from, buff, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
								fs.unlinkSync(media)
								fs.unlinkSync(ran)
							})
...
case 'igpost': 				
				...
				buffer = await getBuffer(anu.result.url)
                                denz.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('dnsnew.jpg')} } }})
				break
		case 'fakeaddress': 
				reply(`[❕] Loading`)
...
// last
				...
				if (isLimit(sender)) return reply(limitend(pushname2))
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						denz.sendMessage(from, buffer, image, {quoted: mek, caption: '𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍'})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender) 
					break 
  ...
  break
			...
			if (!isUser) return reply(mess.only.userB)
				...
				break
					...
					mentions(teks, membr, true)
					break
case 'igstory'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝙅𝙊𝘾𝙆𝙀𝙍
...
case 'covid':
				...
				case 'verify':
					...
					let buff2 = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${pushname2}&member=${user.length}&seri=TM08GK8PPHBSJDH10J&pp=https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg&bg=https://i.postimg.cc/wMGns8Wd/20210517-101434.png`)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}tahta VIRUS`)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix} VIRUS`)
todi = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}8bit VIRUS/bot`)
ds = `${body.slice(6)}`
tex1 = ds.split("/")[0];
tex2 = ds.split("/")[1];
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}glowneon VIRUS`)
tekas = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}gsuggest VIRUS/bot/wea`)
du = `${body.slice(10)}`
ted1 = du.split("/")[0];
ted2 = du.split("/")[1];
ted3 = du.split("/")[2];
...
await limitAdd(sender)
break
case 'silveryt'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝙅𝙊𝘾𝙆𝙀𝙍
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
lsu1 = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}candlemug VIRUS`)
ddu = body.slice(11)
reply(mess.wait)
...
await limitAdd(sender)
break
case 'goldyt'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝙅𝙊𝘾𝙆𝙀𝙍
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
lsu = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}lovemss VIRUS`)
lop = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}mugflower VIRUS`)
mug = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}narutobanner VIRUS ser`)
nar = body.slice(14)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}paperglass VIRUS`)
papg = body.slice(12)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}blueneon VIRUS`)
roce = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}shadow VIRUS`)
sdow = body.slice(8)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Example: ${prefix}sadtext VIRUS ser`)
puiki = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}glitch VIRUS/bot`)
gl = `${body.slice(8)}`
gel1 = gl.split("/")[0];
gel2 = gl.split("/")[1];
reply(mess.wait)
...
case 'attp':
                if (isBanned) return reply(mess.only.benned)    
                if (!isUser) return reply(mess.only.userB)
                if (args.length < 1) return reply(`Example: ${prefix} VIRUS SER`)
                dapuhy = body.slice(5)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}coffe VIRUS`)
kop = body.slice(7)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}matrix VIRUS`)
cndy = body.slice(7)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}hpotter VIRUS`)
hpter = body.slice(9)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}woodblock VIRUS`)
woblk = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}gaminglogo VIRUS ser ofc`)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}galaxtext VIRUS`)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}pupycute VIRUS`)
puki = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}galaxstyle VIRUS`)
gelay = body.slice(12)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}hologram VIRUS`)
gram = body.slice(10)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}metallogo VIRUS`)
metal = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}1917 VIRUS`)
lop1 = body.slice(11)
reply(mess.wait)
...
if (isBanned) return reply(mess.only.benned)    
if (!isUser) return reply(mess.only.userB)
if (args.length < 1) return reply(`Contoh: ${prefix}bpink VIRUS`)
black = body.slice(7)
reply(mess.wait)
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
            ...
            break  
				...
				case 'owner':
                 ...
                 denz.sendMessage(from, '*_ᴛʜᴀᴛ’s ᴍʏ 𝙲𝙷𝚄𝙽𝙺 ᴄʜᴜɢᴀ ᴅᴇᴠᴀɴ 𝚂𝙴𝚁/𝚅𝙸𝚁𝚄𝚂𝚂𝙴𝚁..ᴏʜʜ ᴍᴇᴀɴ 𝙰𝚂𝚂𝙸𝚂𝚃 ᴏᴡɴᴇʀ 𝙽𝙴𝙽𝙱𝙰𝙽 𝙾𝙵 𝚂𝙸𝙳𝙷𝚄𝚂𝙴𝚁_*',text, { quoted: mek} )
                 break
                case 'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
...
┗━━━━━━━━━━━━━━━`, text, { quoted: mek})
         ...
         case 'lirik':
                ...
                if (args.length < 1) return reply(`Yang mau direport apaan? Contoh: #report fitur #hentai error`)
                    ...
                    denz.sendMessage('919497862197@s.whatsapp.net', options, text, {quoted: mek})
...
//akhir kreator
			    ...
			    reply(mess.wait)
			        ...
			        await limitAdd(sender) 
			        break 
			   case 'igstalk'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////4 4 4 UYIR
if (isBanned) return reply(mess.only.benned)    
   					if (!isUser) return reply(mess.only.userB)
...
denz.sendMessage(from, buffer, image, {quoted: mek, caption: teks})
break
case 'playstore'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝘝𝘐𝘙𝘜𝘚 𝑆𝐸𝑅 𝑂𝐹𝐶
if (isBanned) return reply(mess.only.benned)    
   					if (!isUser) return reply(mess.only.userB)
...
reply(teks.trim())
break
case 'ytsearch'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝘝𝘐𝘙𝘜𝘚 𝑆𝐸𝑅 𝑂𝐹𝐶
if (isBanned) return reply(mess.only.benned)    
   					if (!isUser) return reply(mess.only.userB)
...
break
case 'wiki'://𝘝𝘐𝘙𝘜𝘚 𝘚𝘌𝘙 𝘖𝘍𝘊////𝘝𝘐𝘙𝘜𝘚 𝑆𝐸𝑅 𝑂𝐹𝐶
if (isBanned) return reply(mess.only.benned)    
   					if (!isUser) return reply(mess.only.userB)
reply(mess.wait)
...
quoted: mek, caption: `Hasil Dari *${daerah}*`
  ...
  break
			    ...
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔═══✪ Tag By *${pushname2}* ✪══`+ teks +'╚═══〘 *𝚅𝙸𝚁𝚄𝚂 sᴇʀ ᴏғᴄ* 〙═══', members_id, true)
					break
			    case 'mentionall':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
					...
					mentions(`╔══〘  *${body.slice(12)}*  〙✪══`+teks+'╚═〘 *𝚅𝙸𝚁𝚄𝚂 sᴇʀ ᴏғᴄ* 〙', members_id, true)
					break
			    case 'kbbi':
			    if (isBanned) return reply(mess.only.benned)    
			    if (!isUser) return reply(mess.only.userB)
...
case 'husbu':
        ...
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/jget.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
   ...
   if (budy.includes("hai99")){
        ...
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
         ...
         if (budy.includes("Virus")){
		denz.updatePresence(from, Presence.composing)
		const loli = fs.readFileSync('./mp3/virus.mp3')
        denz.sendMessage(from, loli, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
        const d = fs.readFileSync('./sticker/irfan.webp');
        denz.sendMessage(from, d, sticker, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        } 
        ...
        if (budy.includes("919497862197")){  // respon tag ubah aja
        reply(`OI *${pushname2}*, ᴀ𝙽𝙽𝙰 ɴᴛʜɪɴᴀ ɴᴛᴇ ᴠɪʀᴜs sᴇʀ ᴏғᴄ ɴᴇ 𝙼𝙴𝙽𝚃𝙸𝙾𝙽 ᴄʜʏɪᴛʜᴇ!`)
        const d = fs.readFileSync('./sticker/tag.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("VIRUSser")){  // respon tag ubah aja
        reply(`*${pushname2}*, 𝚅𝙸𝚁𝚄𝚂 𝙷𝙴𝚁𝙴 𝙽𝚃𝙷 𝙱𝙴𝙽𝙰𝙼 𝙼𝙾𝙽𝚄𝚂𝙴?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("virus")){  // respon tag ubah aja
        reply(`*${pushname2}*,  ᴀ𝙽𝙽𝙰 ɴᴛʜɪɴᴀ ɴᴛᴇ 𝚅𝙸𝚁𝚄𝚂 ??𝙴𝚁 ᴏғᴄ ɴᴇ 𝙼𝙴𝙽𝚃𝙸𝙾𝙽 ᴄʜʏɪᴛʜᴇ!`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        ...
        reply(`*${pushname2}*, 𝚈𝙴𝚂 𝚅𝙸𝚁𝚄𝚂 𝚂𝙴𝚁 𝙷𝙴𝚁𝙴. 𝙽𝚃𝙷 𝚅𝙴𝙽𝙰𝙼 𝙼𝙾𝙽𝚄?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("VIRUS")){  // respon tag ubah aja
        reply(`*${pushname2}*, 𝚈𝙴𝚂 ᴄʜᴜɢᴀ ᴅᴇᴠᴀɴ 𝚂𝙴𝚁 𝙷𝙴𝚁𝙴. 𝙽𝚃𝙷 𝚅𝙴𝙽𝙰𝙼 𝙼𝙾𝙽𝚄?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("Arjun")){  // respon tag ubah aja
        reply(`*${pushname2}*, 𝙲𝙸𝙳 𝙼𝙾𝙾𝚂𝙰 𝙿𝙴𝚃𝚃𝙸 𝚂𝙴𝚁 𝙽𝙰𝙼𝙴 𝙰𝙻𝙻𝙴 𝙰𝚁𝙹𝚄𝙽 𝚂𝙴𝚁?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("VIRUS")){  // respon tag ubah aja
        reply(`*${pushname2}*, 𝚈𝙷𝙴𝚁𝙴. 𝙽𝚃𝙷 𝚅𝙴𝙽𝙰𝙼 𝙼𝙾𝙽𝚄?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("sidhu")){  // respon tag ubah aja
        reply(`*${pushname2}*,𝚂𝙸𝙳𝙷𝚄 𝚂𝙴𝚁 𝙾𝙵𝙵𝙻𝙸𝙽𝙴 𝙰𝙷𝙽 𝙴𝙽𝙽 𝚃𝙷𝙾𝙽𝚄𝙽𝙽𝚄 𝙿𝙼 𝙿𝙾𝙾`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("virus SER")){  // respon tag ubah aja
        reply(`*${pushname2}*, ᴠɪʀᴜs sᴇʀ 𝙷𝙴𝚁𝙴 𝙽𝚃𝙷 𝙱𝙴𝙽𝙼?`)
        const d = fs.readFileSync('./sticker/anjim.webp');
        denz.sendMessage(from, d, sticker, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "_𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍_", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
        }
        if (budy.includes("919497862197")){
		denz.updatePresence(from, Presence.composing)
		...
		if (budy.includes(`Thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, 𝚊𝚕𝚒𝚘 *${pushname2}*, 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍 >-<`)
                  }
                  if (budy.includes(`Welcome`)) {
                  reply(`𝚃𝙷𝚇, 𝙼𝙾𝙽𝚄 *${pushname2}*, 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍 >-<`)
                  }
                  ...
                  reply(`𝚈𝙴𝚂𝙷 𝙸 𝙰𝙼 𝚅𝙸𝚁𝚄𝚂 𝙱𝙾𝚃.𝚅𝙴𝚁𝚂𝙸𝙾𝙽 444 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 ᴠɪʀᴜs sᴇʀ *${pushname2}*`)
                  }  
                  if (budy.includes(`Bot`)) {
                  reply(`𝚈𝙴𝚂𝙷 𝙸 𝙰𝙼 𝚅𝙸𝚁𝚄𝚂 𝙱𝙾𝚃.𝚅𝙴𝚁𝚂𝙸𝙾𝙽 444 𝙲𝚁𝙴??𝚃??𝙳 𝙱𝚈 ᴠɪʀᴜs sᴇʀ *${pushname2}*`)
                  }  
                  if (budy.includes(`Thyr`)) {
                  reply(`𝙏𝙃𝙔𝙍 𝙰𝙻𝙻𝙰 𝙼𝙾𝙽𝚄𝚂𝙴 𝙈𝙔𝙍 𝙰𝙷𝙽𝚄 *${pushname2}*`)
                  }
                  if (budy.includes(`Endi`)) {
                  reply(`𝙀𝙉𝘿𝙄 𝙴𝙽𝙽𝚄 𝙿𝙰𝚁𝙰𝚈𝙻𝙴 𝙼𝙾??𝚄 𝘼𝙉𝘿𝙄 𝙴𝙽𝙽𝚄 𝙿𝙰𝚁𝙰 *${pushname2}*`)
                  }
                  if (budy.includes(`Myre`)) {
                  reply(`𝙲𝙷𝙴𝙴𝚃𝙷𝙰 𝙿𝙰𝚁𝙰𝚈𝙰𝙻𝙻𝙴 𝙼𝙾𝙽𝚄 𝙏𝙃𝙔𝙍 𝙴𝙽𝙽𝚄 𝙿𝙰𝚁𝙰 *${pushname2}*`)
                  }
                  if (budy.includes(`virus`)) {
                  reply(`ᴠɪʀᴜs sᴇʀ 𝙾𝙵𝙵𝙻𝙸𝙽𝙴 𝙰𝙷𝙽𝙽𝚄 𝚃𝙷𝙾𝙽𝚄𝙽𝙽𝚄 𝙿𝙼 𝙿𝙾𝙾 *${pushname2}*`)
                   }
                  if (budy.includes(`umbi`)) {
                  reply(`𝙴𝚁𝙰𝙺𝙰𝙼 𝚅𝙰𝙺𝙸𝙻 𝙲𝙷𝙴𝙽𝙽 𝙺𝚄𝙽𝙹𝙸𝚁𝙽𝙽 𝙾𝙾𝙼𝙱 *${pushname2}*`)
                  }
                  ...
                  if (budy.includes(`thanks`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, 𝙼𝙾𝙽𝚄 *${pushname2}*, 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍>-<`)
                  }
                  if (budy.includes(`welcome`)) {
                  reply(`ʏᴏᴜ ᴡᴇʟᴄᴏᴍᴇ, 𝙼𝙾𝙽𝚄 *${pushname2}*, 𝙑𝙄𝙍𝙐𝙎 𝙎𝙀𝙍>-<`)
                  }
